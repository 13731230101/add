...
# 加载8条用例
tests = unittest.defaultTestLoader.discover(r"D:\汉科软-phython\day11【单元测试】",pattern="Test*.py")
...
class Send_Email():
    ...
    def send_email(self, report_path):
        ...
        to_list = ['1191513266@qq.com']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱

        mail_user = '1191513266@qq.com'  # 用户名
        mail_pass = 'bwfokbxynjudijge'  # 密码

        with open(report_path, 'rb') as file:
            mail_body = file.read()
            me = "1191513266@qq.com"
